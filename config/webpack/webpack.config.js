...
module.exports = function (webpackEnv) {
  ...
  return {
    entry: "./packages/genshin-teaming-video-app/src/index.tsx",
    ...
    plugins: [
      ...
      new HtmlWebpackPlugin(
        Object.assign(
          ...
          {
            inject: true,
            template: "./packages/genshin-teaming-video-app/public/index.html",
          },
          isProdEnvironment
            ? {
                minify: {
      ...
      sentryWebpackPlugin({
        ...
        org: "paion-data",
        project: "qubitpi-genshin-teaming-videos",
      }),
    ],
    resolve: {
